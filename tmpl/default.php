...
<div class="mod_register_login">
<input checked="checked" id="mod_login" type="radio" name="mod_register_login" />
<input id="mod_register" type="radio" name="mod_register_login" />
  <nav>
    <ul>
      <li class="mod_login">
        <label for="mod_login"><?php echo JText::_('MOD_REGISTERLOGIN_LOGINLEBEL'); ?></label>
      </li>
      <li class="mod_register">
        <label for="mod_register"><?php echo JText::_('MOD_REGISTERLOGIN_REGISTERLEBEL'); ?></label>
      </li>
    </ul>
  </nav>
